...
games <- tribble(~Spiel, ~Phase, ~Begegnung, ~Tore_H, ~Tore_G, ~Tore, # standard: No, "Runde Phase", "Heim Gast", NA, NA, NULL; Abkürzungen in den 'mutate'-Statements
                 ...
                 19, "Gr T2", "swe svk", 1 ,0, "swe 77 pen ld",
                 20, "Gr T2", "cro cze", 1 ,1 ,c("cze 37 pen ld", "cro 47 reg os"),
                 21, "Gr T2", "eng sco", 0, 0, NULL,
                 22, "Gr T2", "hun fra", 1, 1, c("hun 45+2 reg ld", "fra 66 reg os"),
                 23, "Gr T2", "por ger", 2, 4, c("por 15 reg ld", "ger 35 pen os", "ger 39 pen ld", "ger 51 reg ex", "ger 60 reg ex", "por 67 reg cu"),
                 24, "Gr T2", "esp pol", 1, 1, c("esp 25 reg ld", "pol 54 reg os"),
                 25, "Gr T3", "sui tur", 3, 1, c("sui 6 reg ld", "sui 26 reg ex", "tur 62 reg cu", "sui 68 reg ex"),
                 26, "Gr T3", "ita wal", 1, 0, "ita 39 reg ld",
                 27, "Gr T3", "mkd ned", 0, 3, c("ned 24 reg ld", "ned 51 reg ex", "ned 58 reg ex"),
                 28, "Gr T3", "ukr aut", 0, 1, "aut 21 reg ld",
                 29, "Gr T3", "rus den", 1, 4, c("den 38 reg ld", "den 59 reg ex", "rus 70 pen cu", "den 79 reg ex", "den 82 reg ex"),
                 30, "Gr T3", "fin bel", 0, 2, c("bel 74 own ld", "bel 81 reg ex"),
                 31, "Gr T3", "cro sco", 1, 1, c("cro 17 reg ld", "sco 42 reg os", "cro 62 reg ld", "cro 77 reg ex"),
                 32, "Gr T3", "cze eng", 0, 1, "eng 12 reg ld",
                 33, "Gr T3", "svk esp", 0, 5, c("esp 30 own ld", "esp 45+3 reg ex", "esp 56 reg ex", "esp 67 reg ex", "esp 71 own ex"),
                 ...
                 37, "Fi F8", "wal den", 0, 4, c("den 27 reg ld", "den 48 reg ex", "den 88 reg ex", "den 90+4 reg ex"),
