...
games <- tribble(~Anpfiff, ~Phase, ~Begegnung, ~Tore_H, ~Tore_G, ~Tore, # standard: No, "Runde Phase", "Heim Gast", NA, NA, NULL; Abkürzungen in den 'mutate'-Statements
                 ...
                 "2021/6/12/21/0", "Gr T1", "bel rus", 3, 0, c("bel 10 reg ld", "bel 34 reg ex", "bel 88 reg ex"),
                 "2021/6/13/15/0", "Gr T1", "eng cro", 1, 0, "eng 57 reg ld",
                 "2021/6/13/18/0", "Gr T1", "aut mkd", 3, 1, c("aut 18 reg ld", "mkd 28 reg os", "aut 78 reg ld", "aut 89 reg ex"),
                 "2021/6/13/21/0", "Gr T1", "ned ukr", 3, 2, c("ned 52 reg ld", "ned 58 reg ex", "ukr 75 reg cu", "ukr 79 reg os", "ned 85 reg ld"),
                 "2021/6/14/15/0", "Gr T1", "sco cze", 0, 2, c("cze 42 reg ld", "cze 52 reg ex"),
                 "2021/6/14/18/0", "Gr T1", "pol svk", 1, 2, c("svk 18 own ld", "pol 46 reg os", "svk 69 reg ld"),
                 "2021/6/14/21/0", "Gr T1", "esp swe", 0, 0, NULL,
                 "2021/6/15/18/0", "Gr T1", "hun por", 0, 3, c("por 84 reg ld", "por 87 pen ex", "por 90+2 reg ex"),
                 "2021/6/15/21/0", "Gr T1", "fra ger", 1, 0, "fra 20 own ld",
                 "2021/6/16/15/0", "Gr T2", "fin rus", 0, 1, "rus 45+2 reg ld",
                 "2021/6/16/18/0", "Gr T2", "tur wal", 0, 2, c("wal 42 reg ld", "wal 90+5 reg ex"),
                 "2021/6/16/21/0", "Gr T2", "ita sui", 3, 0, c("ita 26 reg ld", "ita 56 reg ex", "ita 89 reg ex"),
                 "2021/6/17/15/0", "Gr T2", "ukr mkd", 2, 1, c("ukr 29 reg ld", "ukr 34 reg ex", "mkd 57 reg cu"),
                 "2021/6/17/18/0", "Gr T2", "den bel", 1, 2, c("den 2 reg ld", "bel 54 reg os", "bel 70 reg ld"),
                 "2021/6/17/21/0", "Gr T2", "ned aut", 2, 0, c("ned 11 pen ld", "ned 67 reg ex"),
                 "2021/6/18/15/0", "Gr T2", "swe svk", 1 ,0, "swe 77 pen ld",
                 ...
                 "2021/6/21/18/0", "Gr T3", "mkd ned", 0, 3, c("ned 24 reg ld", "ned 51 reg ex", "ned 58 reg ex"),
                 "2021/6/21/18/0", "Gr T3", "ukr aut", 0, 1, "aut 21 reg ld",
                 "2021/6/21/21/0", "Gr T3", "rus den", 1, 4, c("den 38 reg ld", "den 59 reg ex", "rus 70 pen cu", "den 79 reg ex", "den 82 reg ex"),
                 "2021/6/21/21/0", "Gr T3", "fin bel", 0, 2, c("bel 74 own ld", "bel 81 reg ex"),
                 "2021/6/22/21/0", "Gr T3", "cro sco", 3, 1, c("cro 17 reg ld", "sco 42 reg os", "cro 62 reg ld", "cro 77 reg ex"),
                 "2021/6/22/21/0", "Gr T3", "cze eng", 0, 1, "eng 12 reg ld",
                 "2021/6/23/18/0", "Gr T3", "svk esp", 0, 5, c("esp 30 own ld", "esp 45+3 reg ex", "esp 56 reg ex", "esp 67 reg ex", "esp 71 own ex"),
                 "2021/6/23/18/0", "Gr T3", "swe pol", 3, 2, c("swe 2 reg ld", "swe 59 reg ex", "pol 61 reg cu", "pol 84 reg os", "swe 90+3 reg ld"),
                 "2021/6/23/21/0", "Gr T3", "por fra", 2, 2, c("por 30 pen ld", "fra 45+2 pen os", "fra 47 reg ld", "por 60 pen os"),
                 "2021/6/23/21/0", "Gr T3", "ger hun", 2, 2, c("hun 11 reg ld", "ger 66 reg os", "hun 68 reg ld", "ger 84 reg os"),
                 "2021/6/26/18/0", "Fi F8", "wal den", 0, 4, c("den 27 reg ld", "den 48 reg ex", "den 88 reg ex", "den 90+4 reg ex"),
                 "2021/6/26/21/0", "Fi F8", "ita aut", 2, 1, c("ita 95 reg ld", "ita 105 reg ex", "aut 114 reg cu"),
                 "2021/6/27/18/0", "Fi F8", "ned cze", 0, 2, c("cze 68 reg ld", "cze 80 reg ex"),
                 "2021/6/27/21/0", "Fi F8", "bel por", 1, 0, "bel 42 reg ld",
                 "2021/6/28/18/0", "Fi F8", "cro esp", 3, 5, c("cro 20 own ld", "esp 38 reg os","esp 57 reg ld", "esp 76 reg ex", "cro 85 reg cu", "cro 90+2 reg os", "esp 100 reg ld", "esp 103 reg ex"),
